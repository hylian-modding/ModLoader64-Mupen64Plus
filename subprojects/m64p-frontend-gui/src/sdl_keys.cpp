...
uint16_t sdl_keysym2native(uint16_t keysym) { return sdl_keysym2scancode(keysym); }
uint16_t sdl_native2keysym(uint16_t native) { return sdl_scancode2keysym(native); }
...
uint16_t sdl_keysym2scancode(uint16_t keysym)
{
    ...
    if (keysym >= ARRAY_SIZE(keysym2scancode)) return 0;
...
uint16_t sdl_scancode2keysym(uint16_t scancode)
{
    ...
    if (scancode >= ARRAY_SIZE(scancode2keysym)) return 0;
